...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="reportTabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="simpan-pinjam-tab" data-toggle="tab" href="#simpan-pinjam"
                                role="tab">
                    ...
                    <div class="tab-content mt-3" id="reportTabsContent">
                        ...
                        <div class="tab-pane fade" id="simpan-pinjam" role="tabpanel">
                            <ul class="nav nav-tabs" id="simpanPinjamTabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="simpanan-tab" data-toggle="tab" href="#simpanan"
                                        role="tab">Simpanan</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pengambilan-tab" data-toggle="tab" href="#pengambilan"
                                        role="tab">Pengambilan Simpanan</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pinjaman-tab" data-toggle="tab" href="#pinjaman"
                                        role="tab">Pinjaman</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pengembalian-tab" data-toggle="tab" href="#pengembalian"
                                        role="tab">Pengembalian Pinjaman</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pengeluaran-sp-tab" data-toggle="tab" href="#pengeluaran-sp"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped datatable">
                                            ...
                                            <tbody>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="6" class="text-center">Tidak ada data pinjaman
                                                        </td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped datatable">
                                            ...
                                            <tbody>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="5" class="text-center">Tidak ada data pengembalian
                                                            pinjaman</td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped datatable">
                                            ...
                                            <tbody>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="5" class="text-center">Tidak ada data pengeluaran
                                                        </td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                        ...
                        <div class="tab-pane fade" id="fotocopy" role="tabpanel">
                            ...
                            <ul class="nav nav-tabs" id="fotocopyTabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="pembayaran-fc-tab" data-toggle="tab"
                                        href="#pembayaran-fc" role="tab">Pembayaran</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pengeluaran-fc-tab" data-toggle="tab" href="#pengeluaran-fc"
                                        role="tab">Pengeluaran</a>
                                </li>
                            </ul>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped datatable">
                                            ...
                                            <tbody>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="5" class="text-center">Tidak ada data pembayaran
                                                            fotocopy</td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                        ...
                        <div class="tab-pane fade" id="brilink" role="tabpanel">
                            ...
                            <ul class="nav nav-tabs" id="brilinkTabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="setor-tab" data-toggle="tab" href="#setor"
                                        role="tab">Setor Tunai</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tarik-tab" data-toggle="tab" href="#tarik"
                                        role="tab">Tarik Tunai</a>
                                </li>
                                <li class="nav-item">
                                        ...
                                        <table class="table table-bordered table-striped datatable">
                                            ...
                                            <tbody>
                                                ...
                                                @forelse($brilinkTransaksi['setor_tunai'] as $item)
                                                    <tr>
                                                        <td>{{ $no++ }}</td>
                                                        <td>{{ \Carbon\Carbon::parse($item->tgl_setor_tunai)->format('d/m/Y') }}
                                                        </td>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="7" class="text-center">Tidak ada data setor tunai
                                                        </td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                        ...
                                        <table class="table table-bordered table-striped datatable">
                                            ...
                                            <tbody>
                                                ...
                                                @forelse($brilinkTransaksi['tarik_tunai'] as $item)
                                                    <tr>
                                                        <td>{{ $no++ }}</td>
                                                        <td>{{ \Carbon\Carbon::parse($item->tgl_tarik_tunai)->format('d/m/Y') }}
                                                        </td>
                                                        <td>{{ $item->kode_transaksi }}</td>
                                                        <td>{{ $item->nama }}</td>
                                                        <td>{{ $item->norek }}</td>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="7" class="text-center">Tidak ada data tarik tunai
                                                        </td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
    ...
    <!-- Form for PDF Export -->
    <form id="exportForm" action="{{ route('laporan.umum.export-pdf') }}" method="POST" target="_blank"
        class="d-none">
        @csrf
            ...
            $('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
                ...
                $(targetId + ' .datatable').each(function() {
                    ...
                    try {
                        ...
                        if (!$.fn.DataTable.isDataTable($table)) {
                            // Validasi struktur tabel
                            if ($table.find('thead tr').length === 0 || $table.find('tbody')
                                .length === 0) {
                                console.warn('Tabel tidak memiliki struktur yang valid', $table);
                                return;
                            }
