...
@section('content')
                                ...
                                @forelse ($setor_tunai as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('brilink.setor-tunai.destroy', $item->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
    ...
    @foreach($setor_tunai as $item)
        ...
        <div class="modal fade" id="modalDetailSetorTunai{{ $item->id }}" tabindex="-1"
            role="dialog" aria-labelledby="modalDetailSetorTunaiLabel{{ $item->id }}"
            aria-hidden="true">
        ...
        <div class="modal fade" id="modalEditSetorTunai{{ $item->id }}" tabindex="-1"
            role="dialog" aria-labelledby="modalEditSetorTunaiLabel{{ $item->id }}"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="{{ route('brilink.setor-tunai.update', $item->id) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="norek"
                                    name="norek" value="{{ $item->norek }}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="tgl_setor_tunai"
                                    name="tgl_setor_tunai" value="{{ $item->tgl_setor_tunai }}" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary"
