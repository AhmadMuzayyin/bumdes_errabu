        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Pengambilan Simpanan</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pengambilan-simpanan.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="tgl_pengambilan">Tanggal Pengambilan <span class="text-danger">*</span></label>
                            <input type="date" name="tgl_pengambilan" id="tgl_pengambilan" class="form-control" value="{{ old('tgl_pengambilan', date('Y-m-d')) }}" required>
                        </div>
